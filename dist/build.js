...
// module
exports.push([module.i, "html{font-size:110%}#app{font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-align:center;color:#2c3e50}h1,h2{font-weight:400}ul{list-style-type:none;padding:0}li{display:inline-block;margin:0 10px}a{color:#42b983}", ""]);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getChar: function getChar(luminance) {
      // ASCII chars
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (Vue, config) {
  Vue.mixin({
    created: function created() {
      this.$config = config;
    }
